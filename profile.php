                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <form action="components/edit_profile.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                            <img src="<?= !empty($_SESSION['user_data']['image']) ? $_SESSION['user_data']['image'] : 'avatars/no-user.jpg'; ?>" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-md-12">
                    ...
                    <div class="col-md-12" style="margin-top: 20px;">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <form action="components/edit_password.php" method="post">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Текущиий пароль</label>
                                                <?php
                                                $is_invalid = '';
