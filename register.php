...
<div id="app">
    ...
    <?php if ($_SESSION['new_user'] == true) : ?>
        <div class="alert alert-success text-center" role="alert">Вы успешно зарегистрировались!</div>
    <?php endif; ?>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="components/auth/registration.php">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right">Подтвердите пароль</label>
                                    <div class="col-md-6">
                                        <?php
                                        $is_invalid = '';
                                        $message = '';
